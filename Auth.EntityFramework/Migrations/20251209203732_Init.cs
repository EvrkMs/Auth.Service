        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandleHash = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sessions_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionHandleHash = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    ClientId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tokens_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_sessions_HandleHash",
                table: "sessions",
                column: "HandleHash");

            migrationBuilder.CreateIndex(
                name: "IX_tokens_EmployeeId_ClientId_Type",
                table: "tokens",
                columns: new[] { "EmployeeId", "ClientId", "Type" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tokens_SessionHandleHash",
                table: "tokens",
                column: "SessionHandleHash");
